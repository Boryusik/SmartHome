...
if\
nde\
f MU_6DC7FC23C29240AC95892AD720A1AF49
\
#\
de\
fin\
e MU_6DC7FC23C29240AC95892AD720A1AF49
...
#define UNIT_IMPL(name) static struct mt__AssertResult name(void){struct mt__AssertResult (*___unsed)(void) = name;struct mt__AssertResult __ok = {MT_FAIL, 0, 0, 0};mt__current_test_name=#name; mt__current_test_was_traced=0;if(___unsed){
